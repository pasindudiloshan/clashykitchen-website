...
if (isset($_POST['update_product'])) {
    ...
    if (isset($_FILES['foodimage']) && $_FILES['foodimage']['error'] === UPLOAD_ERR_OK) {
        ...
        $selectImageQuery = "SELECT image FROM popitems WHERE id = $id";
    ...
    $update = "UPDATE popitems SET name = '$itemName', price = '$itemPrice', image = '$itemImage', info = '$itemDescription' WHERE id = $id";

    if (mysqli_query($connection, $update)) {
        echo '<script>alert("Food Item Updated successfully!"); window.location.href = "addpopitem.php";</script>';
        exit();
    } else {
...
<body>
    ...
    <div class="additem-container">
        <div class="admin-product-from-container centered">
            ...
            <?php
            $select = mysqli_query($connection,"SELECT * FROM popitems WHERE id = '$id'");
            ...
            <form method="post" id="add_food" enctype="multipart/form-data">
                ...
                <a href="addpopitem.php" class="back-btn"><i class="fa-solid fa-rotate-left"></i></a>
            </form>
            <?php }; ?>
